...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return pageMetadata({
    ...
    description: `Live and historical gas prices for ${name}: the Nitro base fee pricer, its constraint backlogs, owner changes, fee destinations and L1 posting costs.`,
