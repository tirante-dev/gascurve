...
describe("NetworkPage with a chain-id route", () => {
  ...
  it("passes the network's pricer model to the history, so an empty set list is not read as legacy", () => {
    ...
    seriesData = {
      ...
      constraintSets: [],
      ownerActions: [],
      points: [{ t: 1, blocks: 1, gasUsed: 1, gasPerSecond: 1, coverage: 1, completeness: "complete", feesWei: "0", baseFeeMin: "1", baseFeeAvg: "1", baseFeeMax: "1", exponentBips: 34, constraintBips: [34, 0], backlogs: [3_111_506, 0], backlogsMax: [3_111_506, 0], minBaseFee: "1", floorFeesWei: "0", surplusFeesWei: "0", constraintSetId: 0, replayErrorBips: 0 }],
    };
