...
describe("DataFooter", () => {
  ...
  it("credits tirante.dev with an external link after the version line", () => {
    render(<DataFooter snapshot={null} series={null} networkInfo={null} status="open" apiStatus={{ version: "1.2.3", listener: { ready: true, reconnects: 0, lastError: null }, networks: [] }} now={0} />);
