...
/** A readable name for a route parameter, for titles rendered on the server before the api has confirmed
 * the network. Slugs become title case; a chain id route is named after the id rather than guessed at. */
