...
func TestPostgresSetBasedRoundTrips(t *testing.T) {
	...
	mock.ExpectExec("INSERT INTO blocks .*\\$1600").WillReturnResult(sqlmock.NewResult(0, rows))
	mock.ExpectExec("INSERT INTO buckets .*\\$2100").WillReturnResult(sqlmock.NewResult(0, rows))
